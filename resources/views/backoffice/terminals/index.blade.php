...
@section('content')
    ...
    <div class="card p-4 mb-3">
        ...
        <form method="GET" action="{{ route('admin.terminals.index') }}" class="mt-3">
            <div class="row g-2">
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                    ...
                    <a class="btn btn-sm btn-outline-secondary" href="{{ route('admin.terminals.index') }}">Reset</a>
                </div>
            </div>
        </form>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-sm mb-0 align-middle">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted p-4">Aucun terminal.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
