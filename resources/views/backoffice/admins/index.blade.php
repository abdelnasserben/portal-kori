        ...
        <form method="GET" action="{{ route('admin.admins.index') }}" class="mt-3">
            <div class="row g-2">
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                    ...
                    <a class="btn btn-sm btn-outline-secondary" href="{{ route('admin.admins.index') }}">Reset</a>
                </div>
            </div>
        </form>
    </div>
